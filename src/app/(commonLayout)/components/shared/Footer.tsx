  ...
  return (
    <footer className="bg-gray-900 text-gray-300 py-8">
      <div className="container  px-4 grid grid-cols-1 md:grid-cols-3 gap-8 max-w-5xl mx-auto">
        ...
        <div className='flex-1 flex justify-center'>
          ...
          <ul className="mt-4 space-y-2">
            <li>
              <Link href="/about" legacyBehavior className="hover:text-gray-400">
                About Us
              </Link>
            </li>
            <li>
              <Link href="/blog" legacyBehavior className="hover:text-gray-400">
                Blog
              </Link>
            </li>
            <li>
              <Link href="/contact"  legacyBehavior className="hover:text-gray-400">
                Contact
              </Link>
            </li>
            <li>
              <Link href="/premium" legacyBehavior className="hover:text-gray-400">
                Premium Content
              </Link>
            </li>
          </ul>
      ...
      <div className="text-center mt-8 text-gray-500 text-sm">
        ...
        <p>
          <Link href="/privacy-policy" legacyBehavior className="hover:text-gray-400">
            Privacy Policy
          </Link> | 
          <Link href="/terms-of-service" legacyBehavior className="hover:text-gray-400">
            Terms of Service
          </Link>
        </p>
      </div>
